...
public class AnimatorRotateCardRightBottom extends BaseAnimator {
    @Override
    ...
    public Animator[] togetherAnimators(View view) {
        return new Animator[]{
                ...
                ObjectAnimator.ofFloat(view, PropertyType.Rotation.getValue(),-180, 0).setDuration(getDuration())
        };
    }
}
