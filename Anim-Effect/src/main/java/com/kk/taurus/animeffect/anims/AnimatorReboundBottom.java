...
public class AnimatorReboundBottom extends BaseAnimator {
    @Override
    public Animator[] togetherAnimators(View view) {
        return new Animator[]{
                ObjectAnimator.ofFloat(view, PropertyType.TranslationY.getValue(), 0,100f,0).setDuration(getDuration()),
        };
    }
}
