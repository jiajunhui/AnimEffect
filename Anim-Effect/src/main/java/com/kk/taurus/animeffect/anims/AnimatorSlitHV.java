...
public class AnimatorSlitHV extends BaseAnimator {
    @Override
    public Animator[] togetherAnimators(View view) {
        return new Animator[]{
                ObjectAnimator.ofFloat(view, PropertyType.RotationX.getValue(), 90,80,60,45,0).setDuration(getDuration()),
                ObjectAnimator.ofFloat(view, PropertyType.RotationY.getValue(), 90,80,60,45,0).setDuration(getDuration()),
