...
public class AnimatorFlipVCircle extends BaseAnimator {
    @Override
    public Animator[] togetherAnimators(View view) {
        return new Animator[]{
                ...
                ObjectAnimator.ofFloat(view, PropertyType.RotationX.getValue(),1080,720,360, 0).setDuration(getDuration()*3/2)
        };
    }
}
