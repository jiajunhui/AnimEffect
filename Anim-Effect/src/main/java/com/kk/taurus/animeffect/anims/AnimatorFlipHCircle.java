...
public class AnimatorFlipHCircle extends BaseAnimator {
    @Override
    public Animator[] togetherAnimators(View view) {
        return new Animator[]{
                ...
                ObjectAnimator.ofFloat(view, PropertyType.RotationY.getValue(),1080,720,360, 0).setDuration(getDuration()*3/2)
        };
    }
}
